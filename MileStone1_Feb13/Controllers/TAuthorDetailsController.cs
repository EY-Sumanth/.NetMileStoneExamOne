...
namespace MileStone1_Feb13.Controllers
{
    public class TAuthorDetailsController : Controller
    {
        ...
        public TAuthorDetailsController(CollegeLibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AuthorId,AuthorName,AuthorSurname")] TAuthorDetail tAuthorDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AuthorId,AuthorName,AuthorSurname")] TAuthorDetail tAuthorDetail)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CollegeLibraryContext.TAuthorDetails'  is null.");
            }
            var tAuthorDetail = await _context.TAuthorDetails.FindAsync(id);
            if (tAuthorDetail != null)
            {
