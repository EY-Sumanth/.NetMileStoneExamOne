...
namespace MileStone1_Feb13.Controllers
{
    public class TBookDetailsController : Controller
    {
        ...
        public TBookDetailsController(CollegeLibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BookId,BookName,AuthorId,PageCount")] TBookDetail tBookDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,BookName,AuthorId,PageCount")] TBookDetail tBookDetail)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CollegeLibraryContext.TBookDetails'  is null.");
            }
            var tBookDetail = await _context.TBookDetails.FindAsync(id);
            if (tBookDetail != null)
            {
