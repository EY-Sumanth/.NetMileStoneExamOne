...
namespace MileStone1_Feb13.Controllers
{
    public class TBorrowDetailsController : Controller
    {
        ...
        public TBorrowDetailsController(CollegeLibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BorrowId,BookId,StudentId,BorrowDate,ReturnDate")] TBorrowDetail tBorrowDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BorrowId,BookId,StudentId,BorrowDate,ReturnDate")] TBorrowDetail tBorrowDetail)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CollegeLibraryContext.TBorrowDetails'  is null.");
            }
            var tBorrowDetail = await _context.TBorrowDetails.FindAsync(id);
            if (tBorrowDetail != null)
            {
